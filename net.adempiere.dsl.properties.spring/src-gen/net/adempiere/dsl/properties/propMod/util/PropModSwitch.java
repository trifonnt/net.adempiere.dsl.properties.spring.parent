 ...
 * @generated
 */
public class PropModSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        PropModel propModel = (PropModel)theEObject;
        T result = casePropModel(propModel);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Prop Model</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Prop Model</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePropModel(PropModel object)
  {
    return null;
  }
